...
rm -fR Documents/workspace/microting/eform-angular-greate-belt-plugin/eform-client/wdio-headless-plugin-step2.conf.ts 
...
cp -a Documents/workspace/microting/eform-angular-frontend/eform-client/wdio-plugin-step2.conf.ts  Documents/workspace/microting/eform-angular-greate-belt-plugin/eform-client/wdio-headless-plugin-step2.conf.ts 
