...
dst_base = os.path.join("Documents", "workspace", "microting", "eform-angular-greate-belt-plugin")

# Remove and copy main directories
paths = [
    (os.path.join("eform-client", "src", "app", "plugins", "modules", "greate-belt-pn"),
     os.path.join("eform-client", "src", "app", "plugins", "modules", "greate-belt-pn")),
    (os.path.join("eFormAPI", "Plugins", "GreateBelt.Pn"),
     os.path.join("eFormAPI", "Plugins", "GreateBelt.Pn")),
]
...
test_files_to_remove = [
    os.path.join("eform-client", "e2e", "Tests", "greate-belt-settings"),
    os.path.join("eform-client", "e2e", "Tests", "greate-belt-general"),
    os.path.join("eform-client", "wdio-headless-plugin-step2.conf.ts"),
    os.path.join("eform-client", "e2e", "Page objects", "GreateBelt"),
]
